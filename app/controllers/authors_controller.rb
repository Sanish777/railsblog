class AuthorsController < ApplicationController
  ...
  def correct_user
    ...
    redirect_to authors_path, notice: "Not Authorized to Edit" if @author.nil?
  end 
  ...
  private
    ...
    def author_params
      params.require(:author).permit(:first_name, :last_name, :email, :phone, :facebook, :user_id, :cover_image)
    end
end
